...
import { clearCart, decrement, increment, removeFromCart } from "../features/cart/cartSlice";
...
function Panier() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      await addOrder({
        customerName: "Client Shop Ma Riad",
      ...
      dispatch(clearCart());
      setFeedback("Commande enregistree avec succes.");
    } catch (error) {
      setFeedback(error.message || "Impossible de valider la commande.");
    } finally {
    ...
    <div className="container py-5">
      <div className="row d-flex justify-content-center my-4">
        <div className="col-md-8">
          ...
          {cartItems.map((item) => (
            <div className="card rounded-3 mb-4 shadow-sm border-0" key={item._id}>
              <div className="card-body p-4">
                <div className="row d-flex justify-content-between align-items-center">
                  ...
                  <div className="col-md-3 col-lg-3 col-xl-3">
                    ...
                    <span className="text-muted small">Ref: {item._id}</span>
                  </div>

                  <div className="col-md-3 col-lg-3 col-xl-2 d-flex align-items-center">
                    <button className="btn btn-link px-2 text-dark" onClick={() => dispatch(decrement(item._id))}>
                    ...
                    <button className="btn btn-link px-2 text-dark" onClick={() => dispatch(increment(item._id))}>
                  ...
                  <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                    <button className="btn text-danger" onClick={() => dispatch(removeFromCart(item._id))}>
        ...
        <div className="col-md-4">
          <div className="card mb-4 border-0 shadow-sm bg-light">
            <div className="card-header py-3 bg-white border-0">
              <h5 className="mb-0 fw-bold">Resume</h5>
            </div>
            <div className="card-body">
              ...
              <button className="btn btn-dark w-100 btn-lg rounded-pill mb-2 shadow-sm" onClick={handleCheckout} disabled={isSubmitting}>
                {isSubmitting ? 'Validation...' : 'Passer la commande'}
              </button>

              {feedback && <p className="small text-center mb-2">{feedback}</p>}
